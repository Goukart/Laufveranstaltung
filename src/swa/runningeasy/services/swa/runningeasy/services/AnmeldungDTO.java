...
public class AnmeldungDTO {
	...
	public AnmeldungDTO(LaeuferDTO laeufer, boolean bezahlt,
			String veranstaltung, String verein, int startnummer) {
		super();
	...
	public String toString() {
		return "AnmeldungDTO [laeufer=" + laeufer + ", bezahlt=" + bezahlt
				+ ", veranstaltung=" + veranstaltung + ", verein=" + verein
